...
module.exports = function (grunt) {
  ...
  grunt.registerMultiTask('copydeps', 'Copy `package.json` dependencies from `node_modules` to a destination of your choosing', function () {
    ...
    dependencies.forEach(function(dependency){
      ...
      // handle dependencies with ".js" in the name, like chart.js or popper.js
      var dependencyJs = dependency;
      if (dependency.indexOf('.js') !== -1) {
        dependencyJs = dependency.replace('.js', '');
      }
    ...
    dependencies.forEach(function(dependency){
      ...
      var ordered = files.filter(function(file) {
        ...
        return file.indexOf( '/' + dependencyJs + '.' ) > 0;
